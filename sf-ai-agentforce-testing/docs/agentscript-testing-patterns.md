...
- [test-spec-reference.md](../resources/test-spec-reference.md) — YAML schema reference
- [topic-name-resolution.md](topic-name-resolution.md) — Topic name format rules
- [agentscript-test-spec.yaml](../templates/agentscript-test-spec.yaml) — Template with all 5 patterns
